...
Update to current module list

Should this be Bundle::Acme::Everything?  Doesn't make much more sense, does it?

=item 0.02

Update to current module list

Include script to update the list
...
Robert Spier and Ask Bjoern Hansen
